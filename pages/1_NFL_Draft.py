...
with tab1:
    ...
    st.markdown("")
    st.markdown("""
Each draft slot is attributed points via the Fitzgerald-Spielberger chart and the consensus mock draft slot comes from Arif Hasan's consensus mock draft board.
